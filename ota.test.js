...
const { buildGithubCommitApiUrl } = require("./repo-updater.js");
...
test("buildGithubCommitApiUrl builds expected commits api url", () => {
  const url = buildGithubCommitApiUrl({ owner: "abc", repo: "repo", branch: "main" });
  assert.equal(url, "https://api.github.com/repos/abc/repo/commits/main");
});
